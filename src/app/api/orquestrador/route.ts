  ...
  try {
    ...
    const response = await client.messages.create({
      ...
      messages: [
        {
          role: 'user',
          content: `Orquestrador financeiro brasileiro. Gere 4 ações baseadas no diagnóstico.

Cubra: tributário (DAS/DARF/INSS/FGTS conforme regime), caixa, categorização, compliance.
Prazos reais: DAS MEI vence dia 20, Simples Nacional dia 20, Lucro Presumido trimestral.
Mensagens curtas e diretas para copiar e enviar.
